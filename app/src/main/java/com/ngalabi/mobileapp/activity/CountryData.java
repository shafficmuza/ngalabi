...
public class CountryData {
    public static final String[] countryNames = {"Uganda", "Afghanistan", "Albania",
            ...
            "United Arab Emirates", "United Kingdom", "Ukraine",
            "Uruguay", "United States", "Uzbekistan", "Vanuatu",
            "Holy See (vatican City State)", "Venezuela", "Viet Nam",
            "Wallis And Futuna", "Yemen", "Zambia", "Zimbabwe"};

    public static final String[] countryAreaCodes = {"256", "93", "355", "213",
            ...
            "993", "688", "971", "44", "380", "598", "1", "998", "678",
